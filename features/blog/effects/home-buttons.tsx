...
export function HomeButtons({
  ...
  return (
    <>
      <Button asChild size="lg" className="h-12 md:h-14 px-8 text-base md:text-lg font-bold group bg-blue-100 hover:bg-blue-200 active:bg-blue-300 dark:bg-blue-500/20 dark:hover:bg-blue-400/30 text-blue-700 dark:text-blue-300 transition-all rounded-full cursor-pointer shadow-sm hover:shadow-md hover:-translate-y-1 duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] relative overflow-visible border-2 border-transparent">
      ...
      <Button variant="outline" asChild size="lg" className="h-12 md:h-14 px-8 text-base md:text-lg font-bold group bg-emerald-100/80 hover:bg-emerald-200/80 active:bg-emerald-300/80 dark:bg-emerald-500/20 dark:hover:bg-emerald-400/30 text-emerald-700 dark:text-emerald-300 transition-all rounded-full cursor-pointer shadow-sm hover:shadow-md hover:-translate-y-1 duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] border-2 border-transparent">
