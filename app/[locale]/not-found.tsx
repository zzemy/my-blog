...
export default function NotFound() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[75vh] px-4 font-sans relative z-10">
      <div className="relative w-full max-w-lg bg-white dark:bg-slate-800/90 rounded-3xl border-2 border-slate-200 dark:border-slate-700 shadow-[8px_8px_0px_#e2e8f0] dark:shadow-[8px_8px_0px_#020617] p-8 md:p-12 text-center flex flex-col items-center space-y-6 group hover:-translate-y-1 transition-transform duration-300">
