...
export function CartoonLandscape() {
  return (
    <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      <div className="absolute top-[45%] md:top-[55%] lg:top-[65%] left-[5%] md:left-[20%] lg:left-[40%] w-6 md:w-8 lg:w-12 h-6 md:h-8 lg:h-12 animate-[slide_45s_linear_infinite] opacity-40 md:opacity-70 hover:opacity-100 transition-opacity">
      ...
      {/* 涂鸦小鸟飞越 (两只) */}
      <div className="absolute top-[12%] md:top-[18%] lg:top-[20%] left-[10%] md:left-[15%] lg:left-[25%] w-4 md:w-6 lg:w-8 h-3 md:h-4 lg:h-6 animate-[slide_40s_linear_infinite] opacity-40 md:opacity-60">
      ...
      <div className="absolute top-[10%] md:top-[16%] lg:top-[18%] left-[8%] md:left-[13%] lg:left-[23%] w-3 md:w-4 lg:w-6 h-2 md:h-3 lg:h-5 animate-[slide_40s_linear_infinite] delay-150 opacity-30 md:opacity-40">
         <svg viewBox="0 0 24 24" className="w-full h-full text-slate-500 dark:text-slate-400">
            <path d="M2 12 Q 7 5, 12 12 Q 17 5, 22 12" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
         </svg>
      </div>
