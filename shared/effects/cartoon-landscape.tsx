...
export function CartoonLandscape() {
  return (
    <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      {/* 统一风格的高颜值云朵 1 (左上方横穿) */}
      <div className="absolute top-[5vh] md:top-[8vh] lg:top-[12vh] left-[-10%] md:left-[5%] lg:left-[8%] w-32 md:w-48 lg:w-64 h-16 md:h-24 lg:h-32 animate-[slide_60s_linear_infinite] opacity-40 md:opacity-30">
        <CloudSvg />
      </div>

      {/* 统一风格的高颜值云朵 2 (右上极高处) */}
      <div className="absolute top-[8vh] md:top-[2vh] lg:top-[5vh] right-[-5%] md:right-[10%] lg:right-[15%] w-24 md:w-40 lg:w-56 h-12 md:h-20 lg:h-28 animate-[slide-reverse_70s_linear_infinite] opacity-40 md:opacity-30">
        <CloudSvg />
      </div>
      
      {/* 统一风格的高颜值云朵 3 (顶部居中偏左) */}
      <div className="absolute top-[18vh] md:top-[18vh] lg:top-[22vh] left-[30%] md:left-[40%] lg:left-[45%] w-20 md:w-32 lg:w-48 h-10 md:h-16 lg:h-24 animate-[slide_55s_linear_infinite] delay-1000 opacity-30 md:opacity-20 block">
        <CloudSvg />
      </div>

      {/* 填补中间空旷区域的云朵 4 */}
      <div className="absolute top-[50vh] md:top-[32vh] lg:top-[38vh] right-[30%] md:right-[40%] lg:right-[50%] w-24 md:w-36 h-12 md:h-18 animate-[slide-reverse_85s_linear_infinite] opacity-30 md:opacity-20 block">
        <CloudSvg />
      </div>

      {/* 添加了一朵低空的云朵 */}
      <div className="absolute top-[75vh] lg:top-[60vh] right-[5%] md:right-[15%] lg:right-[20%] w-20 md:w-28 lg:w-40 h-10 md:h-14 lg:h-20 animate-[slide_90s_linear_infinite] opacity-40 md:opacity-30">
        <CloudSvg />
      </div>

      {/* 填补空隙的涂鸦纸飞机 1 - 避免挡住中间的按钮 */}
      <div className="absolute top-[65vh] md:top-[55vh] lg:top-[65vh] left-[5%] md:left-[20%] lg:left-[40%] w-8 md:w-8 lg:w-12 h-8 md:h-8 lg:h-12 animate-[slide_45s_linear_infinite] opacity-60 md:opacity-50 hover:opacity-100 transition-opacity">
      ...
      <div className="absolute top-[30vh] md:top-[25vh] lg:top-[28vh] right-[10%] md:right-[30%] lg:right-[38%] w-6 md:w-6 lg:w-10 h-6 md:h-6 lg:h-10 animate-[slide-reverse_35s_linear_infinite] delay-500 opacity-60 md:opacity-40 hover:opacity-100 transition-opacity block">
      ...
      {/* 涂鸦小鸟飞越 (两只) */}
      <div className="absolute top-[25vh] md:top-[18vh] lg:top-[20vh] left-[10%] md:left-[15%] lg:left-[25%] w-6 md:w-6 lg:w-8 h-4 md:h-4 lg:h-6 animate-[slide_40s_linear_infinite] opacity-60 md:opacity-40">
      ...
      <div className="absolute top-[22vh] md:top-[16vh] lg:top-[18vh] left-[8%] md:left-[13%] lg:left-[23%] w-4 md:w-4 lg:w-6 h-3 md:h-3 lg:h-5 animate-[slide_40s_linear_infinite] delay-150 opacity-40 md:opacity-30">
         <svg viewBox="0 0 24 24" className="w-full h-full text-slate-500 dark:text-slate-400">
            <path d="M2 12 Q 7 5, 12 12 Q 17 5, 22 12" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
         </svg>
      </div>
      ...
      {/* 卡通太阳/星球 (高处背景) */}
      <div className="absolute top-[-2vh] md:top-[5vh] lg:top-[8vh] right-[-5%] md:right-[8%] lg:right-[12%] w-16 md:w-24 h-16 md:h-24 text-yellow-300 fill-yellow-100 dark:text-yellow-500/60 dark:fill-yellow-500/10 animate-[spin_40s_linear_infinite] opacity-40 md:opacity-60 z-[-1]">
